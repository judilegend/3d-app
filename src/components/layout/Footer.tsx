...
const services = ["UI/UX Design", "Web Development", "Mobile Apps", "Branding"];
    ...
    <footer className="mt-24 pt-12 border-t border-gray-200">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            <h4 className="text-xl font-bold mb-4">BentoDigital</h4>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              {services.map((item) => (
                <li
                  key={item}
                  className="hover:text-primary-600 transition-colors duration-300 cursor-pointer"
                >
                  {item}
                </li>
              ))}
        ...
        <div className="py-6 border-t border-gray-200 text-center text-gray-500 text-sm">
          © {new Date().getFullYear()} BentoDigital. All rights reserved.
        </div>
      </div>
    </footer>
  );
